 ...
 * 
 * NOTE ABOUT GPIO 2
 * to use gpio 2 as an input for the LED, in setup we must set gpio0 as an output and as low
 * pinMode(0,OUTPUT);
 * digitalWrite(0,LOW);
 * 
 * 
...
int redPin = 5; // connect this to the far left lead of the LED
int greenPin = 4;// connect this to the middle right lead of the LED
int bluePin = 9; //connect this to far right lead of the LED
...
//TEST THIS SO WE CAN USE PIN 2 AS A PIN FOR THE LED
  pinMode(0,OUTPUT);
  digitalWrite(0,LOW);
